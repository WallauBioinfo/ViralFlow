...
If you use this workflow for academic purposes, please cite:<br>
...
ViralFlow is a Nextflow pipeline and should be treated as such; check `vfnext/` for more details.<br>
